...
extern void SpliceTrack (UNICODE_CHAR *filespec, UNICODE_CHAR *textspec, UNICODE_CHAR *TimeStamp, CallbackFunction cb);
extern void SpliceMultiTrack (UNICODE_CHAR *TrackNames[], UNICODE_CHAR *TrackText);
...
extern const UNICODE_CHAR *GetTrackSubtitleText (SUBTITLE_REF SubRef);

extern const UNICODE_CHAR *GetTrackSubtitle (void);
